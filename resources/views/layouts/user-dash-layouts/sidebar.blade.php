        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav flex-column">
                    ...
                    <!-- ============================================================== -->
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('user/self-service*') ? 'active' : '' }}" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2">
                            <i class="far fa-user-circle"></i>Employee Self-Service
                        </a>
                        <div id="submenu-2" class="collapse submenu {{ request()->is('user/self-service*') ? 'show' : '' }}">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link {{ request()->is('user/self-service/leave-request') ? 'active' : '' }}" href="{{ url('user/self-service/leave-request') }}">Request Leave</a>
                                </li>
                                {{-- <li class="nav-item">
                                    <a class="nav-link" href="general.html">Leave Management</a>
                                </li> --}}
                                <li class="nav-item">
                                    <a class="nav-link {{ request()->is('user/self-service/schedule') ? 'active' : '' }}" href="{{ url('user/self-service/schedule') }}">My Schedule</a>
                                </li>
                            </ul>
                        </div>
                    </li>
