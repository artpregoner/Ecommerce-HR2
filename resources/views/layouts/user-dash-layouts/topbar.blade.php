<div class="dashboard-header">
    <nav class="navbar navbar-expand-lg bg-white fixed-top">
        <img src="../template/assets/images/storelogo.png" alt="" style="width: 100px; padding-left: 10px;">
                ...
                <li class="nav-item dropdown nav-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                        <div class="nav-user-info">
                            <h5 class="mb-0 text-white nav-user-name">Johnny Yespapa</h5>
                            <span class="status"></span><span class="ml-2">hr@admin.com</span>
                        </div>
                        {{-- <a class="dropdown-item" href="#"><i class="fas fa-user mr-2"></i>Account</a> --}}
                        <a class="dropdown-item" href="#"><i class="fas fa-cog mr-2"></i>Account Setting</a>
